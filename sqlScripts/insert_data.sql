...
INSERT INTO sysDept VALUES('MDC','LAB','Laboratory','AFRIZA',GETDATE(),'AFRIZA',GETDATE(),'NMS','KLM1-JKT05')

INSERT INTO sysDept VALUES('NMD','FIN','Finance','AFRIZA',GETDATE(),'AFRIZA',GETDATE(),'NMS','KLM1-JKT05')

INSERT INTO sysDept VALUES('NMD','ACT','Accounting','AFRIZA',GETDATE(),'AFRIZA',GETDATE(),'NMS','KLM1-JKT05')

INSERT INTO sysDept VALUES('NMD','PUB','Public Relations','AFRIZA',GETDATE(),'AFRIZA',GETDATE(),'NMS','KLM1-JKT05')
