...
CREATE TABLE [dbo].[hosCheckSpecDev] (
    ...
    [curr_rate] DECIMAL(9,0) NOT NULL,
    ...
    [addedAmt] DECIMAL(22,0) NOT NULL,
...
CREATE TABLE [dbo].[hosRegistration] (
    ...
    [isReffered] BIT NOT NULL,
    [refferedDate] DATE NOT NULL,
    [refferedFrom] CHAR(80) NOT NULL,
    [fromPoly_id] CHAR(10) NOT NULL,
    [fromPolyName] CHAR(50) NOT NULL,
    [fromDoctor_id] CHAR(15) NOT NULL,
    [fromDoctorName] CHAR(50) NOT NULL,
    [toPoly_id] CHAR(10) NOT NULL,
    [toPolyName] VARCHAR(50) NOT NULL,
    [toDoctor_id] CHAR(15) NOT NULL,
...
CREATE TABLE [dbo].[hosInsuranceLedger] (
    ...
    [curr_rate] DECIMAL(9,0) NOT NULL,
    [description] VARCHAR(100) NOT NULL,
    [limitAmt] DECIMAL(22,0) NOT NULL,
    [baseAmt] DECIMAL(22,0) NOT NULL,
    [discAmt] DECIMAL(22,0) NOT NULL,
    [tax_id] CHAR(3) NOT NULL,
    [taxRate] TINYINT NOT NULL,
    [taxAmt] DECIMAL(22,0) NOT NULL,
    [trxAmt] DECIMAL(22,0) NOT NULL,
    [claimAmt] DECIMAL(22,0) NOT NULL,
    [balanceAmt] DECIMAL(22,0) NOT NULL,
    [status] TINYINT NOT NULL,
    [createdBy] CHAR(10) NOT NULL,
    [createdAt] DATETIME2 NOT NULL,
    [updatedBy] CHAR(10) NOT NULL,
